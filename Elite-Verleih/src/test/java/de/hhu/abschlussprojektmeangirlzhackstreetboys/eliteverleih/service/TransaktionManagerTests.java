...
public class TransaktionManagerTests {
    ...
    private Long erstelleBeispiel(Calendar start, Calendar ende, int change) {  //change: 0=Angefragt,1=Abgegeben
        ...
        if(change==0) ausleihe.setAusleihStatus(Status.ANGEFRAGT);
        else ausleihe.setAusleihStatus(Status.ABGEGEBEN);
    ...
    private Long erstelleValidesBeispiel(){
