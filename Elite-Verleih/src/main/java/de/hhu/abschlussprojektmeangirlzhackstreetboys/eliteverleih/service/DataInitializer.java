...
public class DataInitializer implements ServletContextInitializer {
    ...
    public void onStartup(ServletContext servletContext)
        ...
        Calendar sCal3 = new GregorianCalendar();
        sCal3.set(2019, 1, 18);
        Calendar eCal3 = new GregorianCalendar();
        eCal3.set(2019, 1, 20);
        Ausleihe test3 = ausleiheM.erstelleAusleihe(new Long(3), new Long(7), sCal3, eCal3);
        ausleiheM.bearbeiteAusleihe(test3.getAusleihId(), Status.BESTAETIGT);
